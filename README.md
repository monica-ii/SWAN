...
- `SWAN_syn_prestack.npz` (18 GB) — [Download Link](#) *(Coming Soon)*
- `SWAN_syn_poststack.npz` (3.9 GB) — [Download Link](#) *(Coming Soon)*
- `SWAN_real_prestack.npz` (372 MB) — [Download Link](#) *(Coming Soon)*
- `SWAN_real_poststack.npz` (6.9 GB) — [Download Link](#) *(Coming Soon)*
